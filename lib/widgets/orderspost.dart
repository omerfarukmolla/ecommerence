...
class _CountryListState extends State<OrdersViewPosts> {
  ...
  void initState() {
   ...
   Future<Orders> fetchPosts() async {
     setState(() {
       this.ord = new Orders(ordamount:0, lOrdersChild: new List<OrdersChild>());
     });
          ...
          height: screenSize.height-100,
           ...
           child:  ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Dismissible(key: new ObjectKey(ord.lOrdersChild[index]), child: _buildProductListRow(ord.lOrdersChild[index]),
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          _buildOrderAmount() {
            return Container(
              child: Text(
                "Order Amount = "+ord.ordamount.toString(),
              ),
            );
