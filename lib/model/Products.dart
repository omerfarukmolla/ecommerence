...
class Products{
  ...
  Products({this.Proid, this.Proval, this.Proname,this.Prodesc,this.Proprice, this.LProductschild});
...
factory Products.fromJson(Map<String, dynamic> json) {
    ...
    return Products(
      ...
      LProductschild : json["productchild"].map<Productschild>((jsonprs) => Productschild.fromJson(jsonprs)).toList()
    );
  }
